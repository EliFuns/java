...
public class ValUtils {
     ...
     **/
    private static final String CHINA_MOVE_PATTERN = "(?:^(?:\\+86)?1(?:3[4-9]|4[7]|5[0-27-9]|7[8]|8[2-478])\\d{8}$)|" +
            "(?:^(?:\\+86)?1705\\d{7}$)";
    /**
     * 密码规则（6-16位字母、数字）
     */
     ...
     * @return boolean
     */
    public static boolean telecom(String mobile) {
        if (StringUtils.isEmpty(mobile)) {
            return Boolean.FALSE;
        }
     ...
     * @return boolean
     */
    public static boolean unionMobile(String mobile) {
        if (StringUtils.isEmpty(mobile)) {
            return Boolean.FALSE;
        }
     ...
     * @return boolean
     */
    public static boolean moveMobile(String mobile) {
        if (StringUtils.isEmpty(mobile)) {
            return Boolean.FALSE;
        }
     ...
     * @return boolean
     */
    public static boolean landLine(final String landline) {
     ...
     * @return boolean
     */
    public static boolean postCode(final String postCode) {
     ...
     * @return boolean
     */
    public static boolean age(final String age) {
     ...
     * @return boolean
     */
    public static boolean idCard(final String idCard) {
     ...
     * @return boolean
     */
    public static boolean url(final String url) {
     ...
     * @return boolean
     */
    public static boolean qq(final String qq) {
     ...
     * @return boolean
     */
    public static boolean chinese(final String str) {
     ...
     * @return boolean
     */
    public static boolean strEnglish(final String str) {
        if (StringUtils.isEmpty(str)) {
            return Boolean.FALSE;
        }
     ...
     * @return boolean
     */
    public static boolean positiveInt(final String str) {
        if (StringUtils.isEmpty(str)) {
            return Boolean.FALSE;
        }
